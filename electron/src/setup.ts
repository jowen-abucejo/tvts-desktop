...
export class ElectronCapacitorApp {
  ...
  async init(): Promise<void> {
    ...
    Menu.setApplicationMenu(
      // Menu.buildFromTemplate(this.AppMenuBarMenuTemplate)//! hide menu bar
      null
    );
    ...
    callback({
      responseHeaders: {
        ...
        'Content-Security-Policy': [
          electronIsDev
            ? //! ? `default-src ${customScheme}://* 'unsafe-inline' devtools://* 'unsafe-eval' data:`//default settings
              `default-src ${domain} ${customScheme}://* 'unsafe-inline' devtools://* 'unsafe-eval' data:`
            : `default-src ${domain} ${customScheme}://* 'unsafe-inline' 'unsafe-eval' data:`,
        ],
      },
    });
  });
